...
\caption{
    ...
    A movie version of this figure is available \editone{online in the HTML version of the paper and} in the supplementary materials \citep{supp}\editone{; in the movie version, the initial Ledoux boundary height is denoted as a dotted orange line}.
\label{fig:dynamics}
}
\end{figure*}

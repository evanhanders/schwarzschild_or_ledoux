...
\caption{
    ...
    \todo{Could you move $\yS$ in the left panel to be inside the blue region, level with $\yS$? I think that might look better and be less ambiguous.}
    ...
    \todo{I think it's confusing that $f_{\rm conv}$ doesn't appear on the left panel. I get why (no motion yet!), so maybe call this out explicitly in the caption?}

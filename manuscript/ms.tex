...
\affiliation{Kavli Institute for Theoretical Physics, University of California, Santa Barbara, Santa Barbara, CA 93106, USA}
...
\begin{abstract}
    ...
    Turbulent convection only occurs in the region which is unstable according to the Ledoux criterion.
    Early in the simulation, the convective boundary is Schwarzschild unstable but Ledoux stable, because there is a composition gradient near the convection zone boundary.

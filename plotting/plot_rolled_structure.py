...
plotter.setup_grid(num_rows=2, num_cols=2, col_inch=float(args['--col_inch']), row_inch=float(args['--row_inch']))
plotter.add_line('z', 'mu', grid_num=0)
plotter.add_line('z', 'bruntN2_structure', grid_num=1)
plotter.add_line('z', 'bruntN2_composition', grid_num=1)
plotter.add_line('z', 'T_ad_z', grid_num=2)
plotter.add_line('z', 'T_z', grid_num=2)
plotter.add_line('z', 'T_rad_z', grid_num=2)
plotter.add_line('z', 'F_conv_mu', grid_num=3)
plotter.add_line('z', 'F_rad_mu', grid_num=3)
plotter.add_line('z', 'F_mu_tot', grid_num=3)
plotter.plot_lines()
